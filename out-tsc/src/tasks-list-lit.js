...
let TasksListLit = class TasksListLit extends LitElement {
    constructor() {
        super(...arguments);
        this.header = `Lista de Tareas`;
        this.tasks = [];
        this.completedTasks = [];
        this.newTask = '';
        this.taskCreationDates = [];
        this.taskCompletionDates = [];
    }
    render() {
        return html `
      <main>
            ...
            ${this.tasks.map((task, index) => html `
                <li>
                  <span 
                    ...
                    @blur="${(e) => this.editTask(index, e.target.textContent)}"
                  >${task}</span>
        ...
        <div class="column completed-list">
          ...
          <ul>
            ${this.completedTasks.map((task, index) => html `
                <li>
                  ${task}
...
], TasksListLit.prototype, "header", void 0);
__decorate([
    property({ type: Array })
], TasksListLit.prototype, "tasks", void 0);
__decorate([
    property({ type: Array })
], TasksListLit.prototype, "completedTasks", void 0);
__decorate([
    property({ type: String })
], TasksListLit.prototype, "newTask", void 0);
__decorate([
    property({ type: Array })
], TasksListLit.prototype, "taskCreationDates", void 0);
__decorate([
    property({ type: Array })
], TasksListLit.prototype, "taskCompletionDates", void 0);
TasksListLit = __decorate([
    customElement('tasks-list-lit')
], TasksListLit);
export { TasksListLit };
//# sourceMappingURL=tasks-list-lit.js.map